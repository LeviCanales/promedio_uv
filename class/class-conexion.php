<?php
	...
	class Conexion{
		protected $dbopts = parse_url(getenv('DATABASE_URL'));

		protected $usuario=$dbopts["user"];
		protected $contrasena=$dbopts["pass"];
		protected $host=$dbopts["host"];
		protected $baseDatos=ltrim($dbopts["path"],'/');
		protected $puerto=$dbopts["port"];
		protected $link;
